<x-layout title="Modifier l'examen" eyebrow="Catalogue">
    <div class="mx-auto max-w-xl">
        ...
        <div class="rounded-xl2 border border-line bg-surface p-6 shadow-card sm:p-8">
            <p class="font-display text-lg font-semibold text-ink">Modifier {{ $examen->nom }}</p>
            <form method="POST" action="{{ route('examens.update', $examen) }}" class="mt-6 space-y-5">
                @csrf
                @method('PUT')
